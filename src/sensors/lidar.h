...
struct Lidar
{
	...
	{
		// TODO:: set minDistance from 0 to 5 to remove points from roof of ego car
		minDistance = 5;
		maxDistance = 50;
		resoultion = 0.2;
		// TODO:: set sderr from 0.0 to 0.2 to get more interesting pcd files
		sderr = 0.2;
		cars = setCars;
		...
		// TODO:: set from pi/6 to pi/64 to get higher resoultion pcd
