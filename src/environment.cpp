...
void simpleHighway(pcl::visualization::PCLVisualizer::Ptr& viewer)
{
    ...
    // initialize Lidar with car-data and ground position 0.0
    Lidar* lidar = new Lidar(cars, 0.0);
    pcl::PointCloud<pcl::PointXYZ>::Ptr inputCloud = lidar->scan();
    //renderRays(viewer, lidar->position, inputCloud);    
    renderPointCloud(viewer, inputCloud, "PointCloud");
...
void cityBlock(pcl::visualization::PCLVisualizer::Ptr& viewer, ProcessPointClouds<pcl::PointXYZI>* pointProcessorI, const pcl::PointCloud<pcl::PointXYZI>::Ptr& inputCloud)
{
    ...
    // following code put to main() for new signature
    ...
    std::vector<pcl::PointCloud<pcl::PointXYZI>::Ptr> cloudClusters = pointProcessorI->Clustering_KdTree(segmentCloud.first, 0.53, 10, 500);
...
int main (int argc, char** argv)
{
    ...
    // following lines commented out for video stream
    //pcl::PointCloud<pcl::PointXYZI>::Ptr inputCloud = pointProcessorI->loadPcd("../../../src/sensors/data/pcd/data_1/0000000000.pcd");
    ...
    while (!viewer->wasStopped ())
    {
        ...
        filename << "sfnd_lidar_" << it << ".png";        
        viewer->saveScreenshot(filename.str());
